    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-orange-100 selection:text-orange-600">
      ...
      <header 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled ? 'bg-white/60 backdrop-blur-sm shadow-sm py-3' : 'bg-transparent py-5'
        }`}
      >
            ...
            <div className="space-y-4">
              {FAQS.map((faq, i) => (
                ...
                >
                  ...
                  >
                    <span className={`font-bold pr-4 ${faq.q.includes('SEO') ? 'text-black' : 'text-slate-900'}`}>
                      {faq.q}
                    </span>
                    {activeFaq === i ? (
                      <ChevronUp className={`${faq.q.includes('SEO') ? 'text-black' : 'text-orange-600'} shrink-0`} />
                    ) : (
                      <ChevronDown className={`${faq.q.includes('SEO') ? 'text-black' : 'text-slate-400'} shrink-0`} />
                    )}
                  </button>
                  <AnimatePresence>
                    {activeFaq === i && (
                      ...
                      >
                        <div className={`px-6 pb-6 leading-relaxed ${faq.q.includes('SEO') ? 'text-black' : 'text-slate-600'}`}>
                          {faq.a}
                        </div>
                      </motion.div>
                    )}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <a 
                  href="https://wa.me/4915734470430" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center text-center gap-4 p-8 rounded-3xl border border-slate-100 hover:border-green-600 hover:bg-green-50 transition-all group shadow-sm"
                >
                  <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center text-green-600 group-hover:bg-green-600 group-hover:text-white transition-all">
                    <MessageCircle size={32} />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">WhatsApp</div>
                    <div className="text-lg font-bold text-slate-900">Direktnachricht</div>
                  </div>
                </a>

                <a 
                  href="mailto:anthonyhodot4@gmail.com" 
                  className="flex flex-col items-center text-center gap-4 p-8 rounded-3xl border border-slate-100 hover:border-orange-600 hover:bg-orange-50 transition-all group shadow-sm"
                >
                  <div className="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center text-orange-600 group-hover:bg-orange-600 group-hover:text-white transition-all">
                    <Mail size={32} />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">E-Mail</div>
                    <div className="text-lg font-bold text-slate-900 truncate max-w-[200px]">anthonyhodot4@gmail.com</div>
                  </div>
                </a>

                <a 
                  href="tel:015734470430" 
                  className="flex flex-col items-center text-center gap-4 p-8 rounded-3xl border border-slate-100 hover:border-orange-600 hover:bg-orange-50 transition-all group shadow-sm sm:col-span-2 lg:col-span-1"
                >
                  <div className="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center text-orange-600 group-hover:bg-orange-600 group-hover:text-white transition-all">
                    <Phone size={32} />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Telefon</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-medium text-slate-500">
              ...
              <Link to="/agb" className="hover:text-orange-600 transition-colors">AGB</Link>
            </div>
